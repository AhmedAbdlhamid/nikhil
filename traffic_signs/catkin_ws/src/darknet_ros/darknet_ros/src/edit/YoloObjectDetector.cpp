...
void YoloObjectDetector::init(){
  ...
  detectionImagePublisher_ = nodeHandle_.advertise<sensor_msgs::Image>(detectionImageTopicName,
                                                                       ...
                                                                       detectionImageLatch);
  ros::Publisher Control_pub = nodeHandle_.advertise<std_msgs::UInt16MultiArray>("Control", 1000);
    ...
    for (int i = 0; i < numClasses_; i++) {
      if (rosBoxCounter_[i] > 0) {
        ...
        for (int j = 0; j < rosBoxCounter_[i]; j++) {
          ...
          std_msgs::UInt16MultiArray new_data;
          new_data.data[0] = xmin;
          new_data.data[1] = ymin;
          new_data.data[2] = xmax;
          new_data.data[3] = ymax;
          new_data.data[4] = rosBoxes_[i][j].prob;
